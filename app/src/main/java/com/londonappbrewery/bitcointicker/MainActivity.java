...
public class MainActivity extends AppCompatActivity {
    ...
    // Constants:
    private String NEW_URL = "https://apiv2.bitcoinaverage.com/indices/global/ticker/BTCAUD";
    ...
    private void letsDoSomeNetworking() {
        ...
        client.get(NEW_URL, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                PriceInfo priceInfo = PriceInfo.fromJSON(response);
    ...
    private void updatePrice(PriceInfo price) {
        mPriceTextView.setText(price.getPriceInfo());
    }
